...
# ============================
SESSION = environ.get('SESSION', 'Movie_watch_pro_bot')
...
PICS = (environ.get('PICS', 'https://graph.org/file/493e6b664fc531f210074-04b55d01c3abc10cf0.jpg https://graph.org/file/bfea54d7a2c920860331c-63660eeff49b2b3498.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/493e6b664fc531f210074-04b55d01c3abc10cf0.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/a6d49505fe90bc492e0f7-b0a9ffcd46a4400534.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/61b3e842d734fb89caf8c-e7e27195172f955cd1.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/cd8a38a7faf563e66fd99-9b0d740742deeaa30a.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://graph.org/file/9a831688fc17466dfdc0a-486f5c24d906ed811b.jpg')).split()  # Fsub pic
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002549725870'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002852175362'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002837642549')  # Channel/Group ID for force sub (make sure bot is admin)
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002837642549').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002549725870').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/cd8a38a7faf563e66fd99-9b0d740742deeaa30a.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '@fam')

#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '').split()]
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @RishuBotz_Bot</b>")
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Rishubots099909:<Rishubots099909@rishubots099909.d0fti7v.mongodb.net/?retryWrites=true&w=majority&appName=Rishubots099909")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://Rishubhai2:Rishubhai2@rishubhai2.gefsdls.mongodb.net/?retryWrites=true&w=majority&appName=Rishubhai2")
DATABASE_NAME = environ.get('DATABASE_NAME', "Rishubots099909")
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002789438648'))  # Log channel id (make sure bot is admin)
...
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/Moviewatchbotott')
OWNERID = int(os.environ.get('OWNERID', '6286894502'))  # Replace with the actual admin ID
